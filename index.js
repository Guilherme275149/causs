...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Minato\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5511934488829:+55 11934488829\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
cr = '*MINATO QUE TÁ NO CONTROLE*'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Minato? Este é um recurso especial para o Minato ❌',
					ownerB: '[❗] Minato? Este é um recurso especial para o Minato ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de MINATO. Registre-se para fazer amizade com o bot Minaro por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Minato|17\n\n──「 MINATO BOT 」──`,
			...
			const mod = [ownerNumber,"5521934488829@s.whatsapp.net"]//ubah nomor lo
			...
			const premium = ["5511934488829@s.whatsapp.net"]
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS MINATO BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Minato domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o Minato ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
